...
public class WorkerServiceProxy extends PoolExector
{
	...
	public WorkerServiceProxy(String host, int port, String sn)
	{
		this.host = host;
		this.port = port;
	...
	@Delegate(interfaceName=Workman.class,methodName="receive",policy= DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=Workman.class,methodName="getHost",policy=DelegatePolicy.Implements)
	public String getHost(){
		return host;
	}
	
	@Delegate(interfaceName=Workman.class,methodName="getPort",policy=DelegatePolicy.Implements)
	public int getPort(){
		return port;
	}
	...
	@Delegate(interfaceName=CtorLocal.class,methodName="giveTask",policy=DelegatePolicy.Implements)
