...
public abstract class Contractor extends ContractorParallel
{
	...
	protected WorkerLocal[] wks = null;
	...
	protected final <T> T[] getLocals(String localType, Class<T> local){
		T[] locals = null;
	...
	protected WorkerLocal[] getWaitingWorkers(String parkhost, int parkport, String workerType){
...
//2013.8.29
	...
	protected Result operateAsyn(final Object instance, final String methodname, final Class[] argsType, final Object[] argsValue)
	{
