...
import com.fourinone.cache.Cache;
import com.fourinone.cache.CacheFacade;
import com.fourinone.cache.CacheLocal;
import com.fourinone.cache.CacheProxy;
import com.fourinone.delegate.DelegateConsole;
import com.fourinone.kv.CoolHashClient;
import com.fourinone.kv.CoolHashCtor;
import com.fourinone.kv.DumpCtor;
import com.fourinone.pattern.CtorLocal;
import com.fourinone.pattern.ParkPatternExector;
import com.fourinone.pattern.park.*;
import com.fourinone.pattern.warehouse.ObjectBean;
import com.fourinone.pattern.worker.*;
...
public class BeanContext extends ServiceContext
{
	...
	public static void startInetServer()
	{
	...
	public static void startWorker(String host, int port, String sn, MigrantWorker mwk, boolean issup)
	{
		try{
	...
	*/
	...
	public static boolean getWindows(boolean defaul){
