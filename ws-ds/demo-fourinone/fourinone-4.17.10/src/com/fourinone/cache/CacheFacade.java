...
import com.fourinone.pattern.park.ParkGroup;
...
public class CacheFacade extends MementoService//implements Cache
{
	...
	@Delegate(interfaceName=Cache.class,methodName="add",policy= DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=Cache.class,methodName="put",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=Cache.class,methodName="get",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=Cache.class,methodName="remove",policy=DelegatePolicy.Implements)
