...
final public class CacheProxy
{
	...
	public CacheProxy(String host, int port)
	{
	...
	@Delegate(interfaceName=CacheLocal.class,methodName="add",policy= DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=CacheLocal.class,methodName="put",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=CacheLocal.class,methodName="get",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=CacheLocal.class,methodName="remove",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=CacheLocal.class,methodName="putByKey",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=CacheLocal.class,methodName="getByKey",policy=DelegatePolicy.Implements)
