...
import com.fourinone.pattern.worker.WorkerService;
...
public class FttpWorkerService extends WorkerService
{
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="read",policy= DelegatePolicy.Implements)
	public byte[] readByte(String f, long b, long t) throws RemoteException,FttpException{
		return readByte(f, b, t, false);
	}
	
	@Delegate(interfaceName=FttpWorker.class,methodName="readLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="readInt",policy=DelegatePolicy.Implements)
	public int[] readInt(String f, long b, long t) throws RemoteException,FttpException{
		return readInt(f,b,t,false);
	}
	
	@Delegate(interfaceName=FttpWorker.class,methodName="readIntLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="write",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="writeLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="writeInt",policy=DelegatePolicy.Implements)
	public int writeInt(String f, long b, long t, int[] its) throws RemoteException,FttpException
	{
		return writeInt(f,b,t,its,false);
	}
	
	@Delegate(interfaceName=FttpWorker.class,methodName="writeIntLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="getFileMeta",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="getChildFileMeta",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="listRoots",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="createFile",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="deleteFile",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="copyFile",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpWorker.class,methodName="renameFile",policy=DelegatePolicy.Implements)
