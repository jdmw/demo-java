...
import com.fourinone.pattern.worker.WorkerServiceProxy;
...
public class FttpWorkerProxy extends WorkerServiceProxy
{
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="readByte",policy= DelegatePolicy.Implements)
	public byte[] read(String f, long b, long t) throws Throwable{
		return read(f,b,t,false);
	}
	
	@Delegate(interfaceName=FttpLocal.class,methodName="readByteAsyn",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="readByteLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="readInt",policy=DelegatePolicy.Implements)
	public int[] readInt(String f, long b, long t) throws Throwable{
		return readInt(f,b,t,false);
	}
	
	@Delegate(interfaceName=FttpLocal.class,methodName="readIntLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="readIntAsyn",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="writeByte",policy=DelegatePolicy.Implements)
	public int write(String f, long b, long t, byte[] bs) throws Throwable{
		return write(f,b,t,bs,false);
	}
	
	@Delegate(interfaceName=FttpLocal.class,methodName="writeByteAsyn",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="writeByteLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="writeInt",policy=DelegatePolicy.Implements)
	public int writeInt(String f, long b, long t, int[] its) throws Throwable{
		return writeInt(f,b,t,its,false);
	}
	
	@Delegate(interfaceName=FttpLocal.class,methodName="writeIntLocked",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="writeIntAsyn",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="getFileMeta",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="getChildFileMeta",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="getListRoots",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="getHost",policy=DelegatePolicy.Implements)
	public String getHost(){
		return host;
	}
	
	@Delegate(interfaceName=FttpLocal.class,methodName="create",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="delete",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="copy",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="copyAsyn",policy=DelegatePolicy.Implements)
	...
	@Delegate(interfaceName=FttpLocal.class,methodName="rename",policy=DelegatePolicy.Implements)
	...
	/*@Delegate(interfaceName=FttpLocal.class,methodName="getPort",policy=DelegatePolicy.Implements)
	public int getPort(){
		this.port = port;
	}*/
}