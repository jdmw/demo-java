...
<style>
    BODY {
        ...
        scrollbar-face-color: #007325;
        scrollbar-shadow-color: #E2FBC4;
        scrollbar-highlight-color: #F0FFF9;
        scrollbar-3dlight-color: #a4b6d7;
        scrollbar-darkshadow-color: #a4b6d7;
        scrollbar-track-color: #F0FFF9;
    ...
    .textedit {
        BORDER-RIGHT: #007325 1px solid;
        BORDER-TOP: #007325 1px solid;
        FONT-SIZE: 12px;
        BORDER-LEFT: #007325 1px solid;
        BORDER-BOTTOM: #007325 1px solid;
        background-color: #F0FFF9;
        color: #007325;
    }
    ...
    .wfbutton {
        BORDER-RIGHT: #1F6CBE 1px solid;
        BORDER-TOP: #1F6CBE 1px solid;
        FONT-SIZE: 12px;
        BORDER-LEFT: #1F6CBE 1px solid;
        BORDER-BOTTOM: #1F6CBE 1px solid;
...
<form name=MyForm method="post">
    ...
    <div nowrap>
        ...
        <a id=proot href="javascript:menuClick(proot)" tid="root" tn="0"><b>Fttp NameNode</b></a><input type=radio
                                                                                                        name="treeId"
                                                                                                        value="isRoot=true&tid=root">
