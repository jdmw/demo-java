package jd.diy.ms.dicovery.registry.struct;
...
public class InstanceInfo {
    ...
    public Set<String> getHealthCheckUrls() {
        LinkedHashSet healthCheckUrlSet = new LinkedHashSet();
    ...
    public synchronized void unsetIsDirty(long unsetDirtyTimestamp) {
        if(this.lastDirtyTimestamp.longValue() <= unsetDirtyTimestamp) {
            this.isInstanceInfoDirty = false;
        }
    ...
    public static final class Builder {
        ...
        public InstanceInfo.Builder setIsCoordinatingDiscoveryServer(boolean isCoordinatingDiscoveryServer) {
            this.result.isCoordinatingDiscoveryServer = Boolean.valueOf(isCoordinatingDiscoveryServer);
            return this;
        }

        public InstanceInfo.Builder setLastUpdatedTimestamp(long lastUpdatedTimestamp) {
            this.result.lastUpdatedTimestamp = Long.valueOf(lastUpdatedTimestamp);
            return this;
        }

        public InstanceInfo.Builder setLastDirtyTimestamp(long lastDirtyTimestamp) {
            this.result.lastDirtyTimestamp = Long.valueOf(lastDirtyTimestamp);
            return this;
        }
    ...
    @JsonProperty("port")
    public PortWrapper portWrapper(){
        return new PortWrapper(isUnsecurePortEnabled,port);
    }
    @JsonProperty("securePort")
    public PortWrapper securePort(){
        return new PortWrapper(isSecurePortEnabled,securePort);
    }
